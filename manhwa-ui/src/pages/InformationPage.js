        ...
        <>
            ...
            <div className="faq-info">
                ...
                <ul id="faq">
                    ...
                    <li><a href="#info-reading-list">How can I keep track of what I'm reading?</a></li>
                </ul>
            </div>
            <hr></hr>
            ...
            <div>
                <h4 id="info-reading-list">Reading Lists</h4>
                <p>Reading lists allow you to track what manhwas you are currently reading. Once you're logged in, click on a manhwa and press 'add to reading list'. You can also remove the manhwa from your list in a similar fashion or if desired you can remove it from your reading list page directly on your user page.</p>
            </div>
        </>
    )
}
